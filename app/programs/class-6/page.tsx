...
export default function ClassSixLanding() {
  ...
  const pricingData = {
    online: [
      ...
      { plan: "Growth Plan ⭐", subjects: "2 Subjects Combo", classes: "16 Classes / Month", fee: "₹5,499", perClass: "₹343", desc: "Our most popular plan. Builds complete concept confidence in both Mathematics and Science.", popular: true },
        ...
        >
          ...
          <motion.div variants={fadeInUpVariant} className="space-y-3 pt-2">
            ...
            <div className="flex flex-wrap gap-2 text-xs font-semibold text-zinc-200">
              {["Class 6 Home Tuition", "Class 6 Online Tuition", "Class 6 Maths Tuition", "Class 6 Science Tuition", "CBSE Class 6 Tuition", "Home Tutor for Class 6"].map((sub) => (
